...
import { ConcentrationAlertContent } from "./sensorTypes/ConcentrationAlert/ConcentrationAlertContent";
...
export type Data = {
  ...
  | {
      ...
      content: BeaconTrackingContent;
    }
  | {
      type: SensorTypeLabels["Boolean"];
  ...
  | {
      type: SensorTypeLabels["Checkout"];
      content: CheckoutContent;
    }
  | {
      type: SensorTypeLabels["ColorPresence"];
      content: ColorPresenceContent;
    }
  | {
      type: SensorTypeLabels["ConcentrationAlert"];
      content: ConcentrationAlertContent;
    }
  | {
  ...
  | {
      type: SensorTypeLabels["FaceRecognition"];
      content: FaceRecognitionContent;
    }
  | {
  ...
  | {
      ...
      content: PoseDetectionContent;
    }
  | {
      type: SensorTypeLabels["QueueSize"];
      content: QueueSizeContent;
    }
  | {
      type: SensorTypeLabels["Referrer"];
      content: ReferrerContent;
    }
  | {
      type: SensorTypeLabels["SceneChange"];
      content: SceneChangeContent;
    }
  | {
      type: SensorTypeLabels["ShoppingHours"];
      content: ShoppingHoursContent;
    }
  | {
      type: SensorTypeLabels["SpeedChange"];
      content: SpeedChangeContent;
    }
  | {
  ...
  | {
      type: SensorTypeLabels["String"];
      content: StringContent;
    }
  | {
      type: SensorTypeLabels["Video"];
